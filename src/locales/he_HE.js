...
T2W.HE.DICTIONARY = {
	zero: "zero",
	ones: ["", "אחד", "שתיים", "שלוש", "ארבע", "חמש", "שש", "שבע", "שמונה", "תשע"],
	teens: ["עשר", "אחד עשרה", "שתיים עשרה", "שלוש עשרה", "ארבע עשרה", "חמש עשרה", "שש עשרה", "שבע עשרה", "שמונה עשרה", "תשע עשרה"],
	tens: ["", "", "עשרים", "שלושים", "ארבעים", "חמישי", "שישים", "שבעים", "eighty", "ninety"],
	hundred: "hundred",
